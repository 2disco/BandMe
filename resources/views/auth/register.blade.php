                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="roleband" class="form-control" name="roleband" required>
                                    @php($rolebandOptions = [
                                    ...
                                    @foreach($rolebandOptions as $roleband)
                                        <option value="{{ $roleband }}"> {{ strtoupper($roleband) }}</option>
                                    @endforeach
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <div class="checkbox">
                                    <label for="privacy">
                                        <input id="privacy" type="checkbox" name="privacy" value="1" required> {{ __('I accept the terms of service ') }}
                                    </label>
                                </div>
